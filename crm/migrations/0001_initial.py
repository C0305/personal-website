    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('company', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='commons.company')),
            ],
            options={
                'ordering': ['-created_on'],
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_on', models.DateTimeField(auto_now_add=True, verbose_name='Created on')),
                ('is_active', models.BooleanField(default=False)),
                ('address', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='crm.address')),
                ('assigned_to', models.ManyToManyField(related_name='crm_contact_to_users', to=settings.AUTH_USER_MODEL)),
                ('company', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='commons.company')),
                ('created_by', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='crm_contact_by_users', to=settings.AUTH_USER_MODEL)),
            ],
            options={
                'ordering': ['-created_on'],
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('from_account', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='crm.account')),
                ('recipients', models.ManyToManyField(to='crm.Contact')),
            ],
        ),
        migrations.CreateModel(
            name='Lead',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('email', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='crm.email')),
            ],
        ),
        migrations.AddField(
            model_name='account',
        ...
        migrations.AddField(
            model_name='account',
            name='lead',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='crm.lead'),
        ),
        migrations.AddField(
            model_name='account',
            name='tags',
